...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <?php if (isset($_SESSION['user']) && (isset($_SESSION['role']) && ($_SESSION['role'] == 'patient' || $account->isAdmin()))) { ?>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="shadow p-3 mb-5 bg-body rounded">
            ...
            <form class="row g-3" method="POST" action="../assets/dist/php/donate.action.php">
              
              <!-- REVISED RESERVED (schedule date - blood type) -->
              <h1 class="display-6">Blood Donate</h1>
              <hr>
              <div class="col-md-12">
    ...
    <?php include '../assets/dist/php/alert.script.php'; ?>
