                    ...
                    <div class="container">
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                  ...
                                                  <button type="submit" id="saveBtn_<?php echo $row['USER_ID']; ?>" class="btn btn-primary" hidden>Save</button>
                                                  <button type="button" class="btn btn-secondary" id="editBtn_<?php echo $row['USER_ID'] ?>" onclick="onEditEvent(<?php echo $getUserId; ?>)">Edit</button>
                                                </div>
                                                </form>
                                              </div>
                                            </div>
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
                                              <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                  ...
                                                  <h2 class="text-center"><?php echo '[' . $getUserId . '] ' . $row['name']; ?></h2>
                                                </div>
                                                <div class="modal-footer">
                        ...
                        <script>
                          ...
                          function onEditEvent(id) {
                              ...
                              var edit = doc.getElementById('editBtn_' + id);
                              var name = doc.getElementById('manage_name_' + id);
                              var bloodtype = doc.getElementById('manage_bloodtype_' + id);
                              var age = doc.getElementById('manage_age_' + id);
                              var sex = doc.getElementById('manage_sex_' + id);
                              var address = doc.getElementById('manage_address_' + id);
                              var province = doc.getElementById('manage_province_' + id);
                              var email = doc.getElementById('manage_email_' + id);
                              var contact = doc.getElementById('manage_contact_' + id);
                              var check = doc.getElementById('check_' + id);
                              var save = doc.getElementById('saveBtn_' + id);

                              if (check.readOnly) {
                                edit.innerHTML = 'Cancel';
                                name.readOnly = false;
                                bloodtype.disabled = false;
                                age.readOnly = false;
                                sex.disabled = false;
